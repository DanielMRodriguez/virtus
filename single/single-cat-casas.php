...
<div class="container-full" id="hero"
    style="background-image: url(<?php echo the_field('imagen_header') ?>);margin-bottom:0;">
...
<div class="container-full">
    <div class="caracteristicas__container">
        ...
        <?php while (have_rows('caracteristicas')) : the_row();
                    $image = get_sub_field('caracteristica_imagen');
                    $text = get_sub_field('caracteristica_text'); ?>
...
<div class="container-full">
    <div class="imagenes-titulos__container">
        <?php
            if (have_rows('img-and-titulos')) : ?>
        <?php while (have_rows('img-and-titulos')) : the_row();
                    $image = get_sub_field('imagen');
                    $text = get_sub_field('titulo'); ?>
        <div class="imagenes-titulos__item">
            <img src="<?php echo $image; ?>" alt="image">
            <h4>
                <?php echo $text; ?>
            </h4>
...
<?php if (get_field('fraccionamiento_texto') != '') : ?>
...
<div class="container-full tourvirtual-seccion">
    <div class="tourvirtual">
        <iframe width='853' height='480' src='<?php echo the_field('tourvirtual'); ?>' frameborder='0' allowfullscreen
...
<?php if (get_field('ultima_seccion-titulo') != '') : ?>
